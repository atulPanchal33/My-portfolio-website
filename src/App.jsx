...
export default function Portfolio() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'about', 'experience', 'education', 'skills', 'work', 'testimonials', 'services', 'contact'];
  ...
  const projects = [
    {
      ...
      live: "https://collaboration-with-atul.vercel.app/",
      features: ["Harley-Davidson", "TVS", 'Royal Enfield', 'Hero', 'Mahindra', 'BMW', 'KTM']
    },
    {
      ...
      github: "https://github.com/atul-panchal/agency",
  ...
  const education = [
    ...
    },
    {
      ...
      year: "2021-24",
      description: "Comprehensive study of business management, accounting, and organizational development.",
      skills: ['Communication','Buissness'],
      icon: BookOpen
    },
    //   {
    ...
    //   location: "India",
    //   year: "2023",
    //   description: "Developed high knowledge of computers.",
    //   skills: ['MS Excel','Typing','Powerpoint','Photoshop','Msword'],
    //   icon: BookOpen
    // }
    ...
    <div className={`min-h-screen ${bgClass} ${textClass} transition-colors duration-300`}>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="max-w-5xl text-center">
          <div className="mb-8">
            <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-r from-purple-400 to-pink-500 p-1 animate-pulse">
            ...
            <h2 className="text-6xl md:text-7xl font-bold mb-4">
              Hi, I'm <span className="bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">Atul</span>
            </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {experience.map((exp, idx) => (
              <div key={idx} className={`${cardBgClass} rounded-xl p-8 backdrop-blur-sm border-l-4 border-purple-500 hover:transform hover:scale-[1.02] transition-all duration-300`}>
                <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                  <div className="flex items-start mb-4 md:mb-0">
                    <div className={`p-3 rounded-lg ${darkMode ? 'bg-slate-700' : 'bg-gray-200'} mr-4`}>
                      <exp.icon className="text-purple-400" size={24} />
                    </div>
                    <div>
                      <h4 className="text-2xl font-semibold mb-1">{exp.title}</h4>
                      <p className="text-purple-400 font-medium">{exp.company}</p>
                      <p className={`text-sm ${darkMode ? 'text-slate-400' : 'text-gray-600'}`}>{exp.period}</p>
                    </div>
                  </div>
                </div>
                <p className={`${darkMode ? 'text-slate-300' : 'text-gray-600'} mb-4`}>{exp.description}</p>
                <div className="space-y-2">
                  <p className="font-semibold text-purple-400 mb-2">Key Achievements:</p>
                  {exp.achievements.map((achievement, i) => (
                    <div key={i} className="flex items-start">
                      <CheckCircle className="text-purple-400 mr-2 mt-1 flex-shrink-0" size={16} />
                      <span className={`text-sm ${darkMode ? 'text-slate-300' : 'text-gray-600'}`}>{achievement}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section id="testimonials" className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-4xl font-bold mb-4 text-center">Client Testimonials</h3>
          <p className={`text-center ${darkMode ? 'text-slate-400' : 'text-gray-600'} mb-12 max-w-2xl mx-auto`}>
            What clients say about working with me
          </p>

          <div className={`${cardBgClass} rounded-2xl p-8 md:p-12 backdrop-blur-sm relative`}>
            <MessageSquare className="absolute top-6 left-6 text-purple-400/20" size={48} />
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-purple-400">{testimonials[testimonialIndex].role}</p>
                  <p className={`text-sm ${darkMode ? 'text-slate-400' : 'text-gray-600'}`}>{testimonials[testimonialIndex].company}</p>
                </div>
              </div>
              ...
              <p className={`text-lg ${darkMode ? 'text-slate-300' : 'text-gray-700'} italic mb-6`}>
                ...
                {testimonials.map((_, idx) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all ${
                      idx === testimonialIndex ? 'bg-purple-400 w-8' : 'bg-slate-600'
                    }`}
                  />
                ))}
              </div>
      ...
      <section id="contact" className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6 mb-12">
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=panchalatul642@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://github.com/atulPanchal33"
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center justify-center w-14 h-14 ${
                darkMode ? 'bg-slate-800' : 'bg-white shadow-md'
            ...
            <a
              href="https://www.linkedin.com/in/atul-panchal33/"
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center justify-center w-14 h-14 ${
                darkMode ? 'bg-slate-800' : 'bg-white shadow-md'
        ...
        <div className={`max-w-6xl mx-auto`}>
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className={`text-center md:text-left mb-4 md:mb-0 ${darkMode ? 'text-slate-400' : 'text-gray-600'}`}>
              <p className="font-semibold mb-1">&copy; 2025 Atul Panchal. All rights reserved.</p>
            ...
            <div className="flex space-x-6">
              ...
              <a
                href="https:// panchalatul642@gmail.com /mail/?view=cm&fs=1&to=atul.panchal@email.com"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-purple-400 transition-colors"
              >
          ...
          <div className={`mt-6 pt-6 border-t ${borderClass} text-center text-sm ${darkMode ? 'text-slate-500' : 'text-gray-500'}`}>
            <p>Designed & Developed by Atul Panchal | India</p>
          </div>
        </div>
      </footer>
